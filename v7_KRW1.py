...
file_handler = logging.FileHandler(filename='./log/v7_KRW1.txt')
...
while True:
    ...
    #    time.sleep(1)
    #if (while_cnt == 100):
    #    upbit.buy_market_order("KRW-DOGE", 10000)
    #    time.sleep(10)
    #    btc_price = pyupbit.get_current_price("KRW-DOGE")
    #    btc_balance = 10000/btc_price
    #    upbit.sell_market_order("KRW-DOGE", btc_balance * 0.99)
    #    time.sleep(10)
    #    while_cnt = 0
    #else:
